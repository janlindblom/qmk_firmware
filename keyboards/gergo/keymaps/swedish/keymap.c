...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_DOT_COL] = ACTION_TAP_DANCE_DOUBLE(KC_COMM, SE_SCLN),
    [TD_COM_SCL] = ACTION_TAP_DANCE_DOUBLE(KC_DOT, SE_COLN),
 ...
 * |---------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |Ctrl/BS  |   A  |   S  |  D   |   F  |   G  |  H   |           | BKSP |   H  |   J  |   K  |   L  |   Ö  | Ctrl/Ä |
 * |---------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 * |Shft/Caps|   Z  |   X  |   C  |   V  |   B  | Tab  |           |      |   N  |   M  | , ;  | . :  | - _  |Shft/'* |
 * `---------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *                    .----------.   .-------.                                 .-----------.   .-----.
...
[BASE] = LAYOUT_gergo(
    ...
    TD(TD_SHFT_CAPS),      KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_TAB, KC_BTN2,     KC_PGDN, KC_TRNS,  KC_N, KC_M,  TD(TD_COM_SCL), TD(TD_DOT_COL), TD(TD_DASH_USCR), MT(MOD_RSFT, SE_QUOT),
 ...
 *
 * ,-------------------------------------------.                         ,-------------------------------------------.
 * |  Cut   |   1  |  2   |  3   |  4   |  5   |                         |  6   |  7   |  8   |  9   |  0   |Ply/Paus|
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |  Copy  |  F1  | F2   | F3   | F4   | F5   | F6   |           |      | LEFT | DOWN |  UP  | RIGHT| PgUp | Vol+   |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 * |  Paste |  F7  | F8   | F9   | F10  | F11  | F12  |           |      | <==  |  ==> | Home | End  | PgDn |  Vol-  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *                        .------.   .------.                                 .------.   .-----.
 *                        |      |   |      |                                 |      |   | DEL |
 *                        '------'   '------'                                 `------.   '-----'
...
[NUMB] = LAYOUT_gergo(
    ...
    KC_COPY, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                         KC_TRNS,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGUP, KC_VOLU,
    KC_PSTE, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,     KC_TRNS, KC_TRNS, C(KC_LEFT), C(KC_RGHT), KC_HOME, KC_END, KC_PGDN, KC_VOLD,
