...
#define SE_GRV  S(KC_EQL) // ` (dead)

#define SE_CIRC S(KC_RBRC) // ^ (dead)
...
#define SE_BSLS ALGR(KC_MINS) // (backslash)

#define SE_TILD ALGR(KC_RBRC) // ~ (dead)
...
[BASE] = LAYOUT_gergo(
    ...
    SFT_T(KC_CAPS),               KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_BTN1, KC_BTN2,     KC_PGDN, KC_TRNS,  KC_N, KC_M, KC_COMM, KC_DOT, SE_MINS, SE_QUOT,
...
[SYMB] = LAYOUT_gergo(
    ...
    KC_TRNS, SE_PERC, SE_CIRC, SE_LBRC, SE_RBRC, SE_TILD, SE_CURR, KC_TRNS,        KC_PGUP, KC_TRNS, SE_AMPR, SE_EQL,  KC_COMM, KC_DOT,  SE_BSLS, KC_TRNS,
 ...
 */
[NUMB] = LAYOUT_gergo(
    C(KC_X), KC_1, 	  KC_2,    KC_3,    KC_4,    KC_5,                                             KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MPLY,
    C(KC_C), KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                         KC_TRNS,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_HOME, KC_END,
    C(KC_V), KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,     KC_TRNS, KC_TRNS,  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_VOLD, KC_VOLU,
