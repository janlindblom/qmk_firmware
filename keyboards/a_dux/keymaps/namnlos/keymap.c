...
/*  %        ^        [        ]        "            &        =        ;        :        \\       */
    SE_PERC, SE_CIRC, SE_LBRC, SE_RBRC, SE_DQUO,     SE_AMPR, SE_EQL,  SE_LABK, SE_RABK, SE_BSLS,
...
#endif
    return update_tri_layer_state(state, _SYMB, _NUMB, _ADJST);
}
