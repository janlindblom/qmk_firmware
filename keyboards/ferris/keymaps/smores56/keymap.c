...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT(
        ...
        KC_Q, KC_V, KC_W, KC_D, KC_J,       KC_B,  KC_H, KC_QUOT, KC_DOT,  KC_SLSH,
    ...
    [_SYM_LMOD] = LAYOUT(
        ...
        KC_NO, C(S(KC_TAB)), C(KC_TAB), KC_NO,   KC_CAPS,    S(KC_7),    S(KC_LBRC), S(KC_RBRC), S(KC_2),   KC_NO,
    ...
    [_NUM_RMOD] = LAYOUT(
        ...
        S(KC_6), KC_4, KC_5, KC_6,   S(KC_EQL),    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
