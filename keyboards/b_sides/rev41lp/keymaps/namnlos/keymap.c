...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADJST] = LAYOUT_rev41lp(
        XXXXXXX,   XXXXXXX, XXXXXXX,   BL_OFF,  BL_DOWN,   BL_TOGG,            BL_BRTG, BL_UP,   BL_ON,   XXXXXXX, XXXXXXX,  XXXXXXX,
        XXXXXXX,  KC_ADESK,KC_KICAD,  XXXXXXX,   SK_BLL, KC_GAMING,            NK_ON,   KO_ON,   AC_ON,   AS_ON,   XXXXXXX,  XXXXXXX,
    ...
    [_KICAD] = LAYOUT_rev41lp(
         KC_ESC,     KC_Q,     KC_W,     KC_E,     KC_R,      KC_T,            KC_Y,     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_QWERTY,
    ...
    [_ADESK] = LAYOUT_rev41lp(
         KC_ESC,      KC_I,    KC_M,     KC_E,     KC_R,      KC_T,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_QWERTY,
    ...
    [_GAMING] = LAYOUT_rev41lp(
        ...
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,               KC_N,     KC_M,  SE_COMM,   SE_DOT,  SE_MINS,  CK_QUOT,
                                              KC_DEL,    KC_ENT,  KC_SPC,   CK_ENT1,  KC_QWERTY
    )
    // clang-format on
};
