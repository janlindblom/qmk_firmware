...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT(
              KC_Z, KC_F, KC_M, KC_P, KC_V,         KC_SCLN,  KC_DOT, KC_SLSH, S(KC_QUOT), KC_QUOT,
              KC_R, KC_S, KC_N, KC_T, KC_B,         KC_COMM,  KC_A,   KC_E,    KC_C,       KC_I,
              KC_X, KC_G, KC_L, KC_D, KC_K,         KC_MINUS, KC_U,   KC_O,    KC_W,       KC_Y,
                                LMOD, SPC_NAV,      H_FN,     RMOD
    ),

    [_SYM_LMOD] = LAYOUT(
                 KC_NO,       C(S(KC_TAB)), C(KC_TAB), KC_CAPS, KC_NO,        S(KC_GRV),  S(KC_LBRC), S(KC_RBRC), S(KC_3),   KC_NO,
                 A(KC_LEFT),  LALT_,        LCTL_,     LSFT_,   KC_PSCR,      S(KC_COMM), S(KC_9),    S(KC_0),    S(KC_DOT), KC_BSLS,
                 A(KC_RIGHT), C(KC_W),      C(KC_Q),   LGUI_,   KC_NO,        KC_GRAVE,   KC_LBRC,    KC_RBRC,    S(KC_2),   S(KC_5),
                                                       KC_NO,   KC_NO,        KC_BSPC,    KC_ENTER
    ),

    [_NUM_RMOD] = LAYOUT(
                    KC_NO,   KC_7,  KC_8,  KC_9,   S(KC_8),        KC_NO, KC_CAPS, KC_NO, KC_NO,   KC_NO,
                    S(KC_6), KC_1,  KC_2,  KC_3,   KC_EQL,         KC_NO, RSFT_,   RCTL_, RALT_,   KC_NO,
                    S(KC_4), KC_4,  KC_5,  KC_6,   S(KC_EQL),      KC_NO, RGUI_,   RSG_,  C(KC_C), KC_NO,
                                           KC_DOT, KC_0,           KC_NO, KC_NO
    ),

    [_NAV] = LAYOUT(
                 KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT,  KC_MUTE,      RALT_,  G(KC_D),     G(S(KC_D)), G(KC_Q),  KC_NO,
    ...
    [_FN] = LAYOUT(
               KC_NO, KC_F7, KC_F8, KC_F9, KC_F10,      KC_NO, KC_BRID, KC_BRIU, KC_NO, KC_NO,
...
const key_override_t exclamation_mark_override = ko_make_basic(MOD_MASK_SHIFT, KC_COMM, S(KC_SLSH));
