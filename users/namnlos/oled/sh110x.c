...
Version for SH1107 with support for flipping and rotating is
 Copyright © 2022 Jan Lindblom (@janlindblom), based on version
 by @drashna in file /users/drashna/oled/sh110x.c.
...
#ifndef SH1107_DISPLAY_START_LINE
#    define SH1107_DISPLAY_START_LINE 0xDC
#endif
#ifndef SH1107_MEMORY_MODE_PAGE
#    define SH1107_MEMORY_MODE_PAGE 0x20
#endif
#ifndef SH1107_MEMORY_MODE_VERTICAL
...
#    if (OLED_DISPLAY_WIDTH == 128) && (OLED_DISPLAY_HEIGHT >= 64)
        0x00,
#    elif (OLED_DISPLAY_WIDTH == 64) && (OLED_DISPLAY_HEIGHT == 128)
        0x60,
#    endif
#else
        0x00,
...
#if (OLED_IC == OLED_IC_SH1106) || (OLED_IC == OLED_IC_SH1107)
...
#if (OLED_IC == OLED_IC_SH1107) || (OLED_IC == OLED_IC_SH1106)
